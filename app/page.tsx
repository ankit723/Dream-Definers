  ...
  return (
    <section>
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative container mx-auto z-10 flex flex-col md:flex-row items-center justify-between h-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 sm:py-12 md:py-0">
          <div className="text-white text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold flex flex-col gap-4 sm:gap-6 md:gap-8 lg:gap-10 text-center md:text-left w-full md:w-auto">
            <div className="space-y-1 sm:space-y-2">
              <h1 className="leading-tight">Transforming Learners</h1>
              <h1 className="leading-tight">Into <span className="text-blue-800">Leaders!</span></h1>
            </div>
            <div className="flex items-center justify-center md:justify-start gap-2 sm:gap-3 flex-wrap mt-2 sm:mt-4">
              {social().map((item) => (
                <Link
                  href={item.url}
                  key={item.name}
                ...
                >
                  <item.icon
                    className={cn(
                      "size-4 xs:size-5 sm:size-6 md:size-7",
        ...
        <div className="my-8 sm:my-12 md:my-16 lg:my-20 xl:my-24 container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">          
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16">
            ...
            <div className="flex-1 w-full lg:w-auto">
              <Image src="/assets/home/speciality/graph.png" alt="Speciality" width={500} height={500} className="w-full max-w-full sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-[500px] h-auto mx-auto"/>
        ...
        <div className="my-8 sm:my-12 md:my-16 lg:my-20 xl:my-24 container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center w-full gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16">
            <div className="flex flex-col items-start justify-center w-full lg:w-1/2">
              <Image src="/assets/home/founders/sonali.png" alt="Founder 1" width={600} height={450} className="w-full h-auto rounded-lg" />
            ...
            <div className="flex flex-col items-start justify-center w-full lg:w-1/2">
              <Image src="/assets/home/founders/randhir.png" alt="Founder 2" width={600} height={450} className="w-full h-auto rounded-lg" />
